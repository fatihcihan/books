...
// Initial value given and export
// Imported to the relevant component
// Assigned the context to the relevant component with the help of the context type
// We got the relevant data with the help of this.context

// 2) Provider --> Consumer

// We created a class component and put the data in state
// We got the data in the state with the provider of the context
// Parent child relationship -> {this.props.children}
// We import the context to the component to which we will send the data
// We capture the data (from provider) that comes with the consumer in the render